...
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (9, 'Ruth', 'Jenkins', 'Laura', 'hYRpSEz5y2', 'ljenkins4@cnbc.com', true, 78);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (10, 'Ann', 'Murphy', 'Brian', '0GmSmOQQV', 'bmurphy5@surveymonkey.com', false, 17);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (11, 'Carl', 'Hawkins', 'Carl', 'Y8PBn9FPe', 'chawkins6@microsoft.com', false, 73);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (12, 'Charles', 'Ray', 'Kevin', 'uHM2JVoQUn', 'kray7@skyrock.com', true, 12);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (13, 'Sandra', 'Taylor', 'Joyce', 's51fjHYhLtjz', 'jtaylor8@t-online.de', false, 78);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (14, 'Lisa', 'Greene', 'Earl', 'rgj5lF3XMUv', 'egreene9@cyberchimps.com', false, 14);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (15, 'Virginia', 'Bryant', 'Pamela', 'Re4JrN7M56', 'pbryanta@illinois.edu', true, 19);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (16, 'Anthony', 'Porter', 'Gloria', '4sRgz7GK23uz', 'gporterb@blogtalkradio.com', false, 11);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (17, 'Janet', 'Phillips', 'Annie', 'GkakJh0p67', 'aphillipsc@netlog.com', true, 1);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (18, 'Lori', 'Fields', 'Steve', '7E13bt2i', 'sfieldsd@desdev.cn', true, 3);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (19, 'Christine', 'Welch', 'Frances', 'kTEPwT', 'fwelche@wikia.com', true, 95);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (20, 'Shirley', 'Wheeler', 'Virginia', 'kSfOY8PX', 'vwheelerf@google.com.br', false, 66);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (21, 'Chris', 'Arnold', 'Janice', '14Bpgxh', 'jarnoldg@imageshack.us', true, 25);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (22, 'Bonnie', 'Bishop', 'Betty', 'SZ19pY', 'bbishoph@trellian.com', false, 14);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (23, 'Martha', 'Mcdonald', 'Ashley', '1sHreJ', 'amcdonaldi@google.co.uk', true, 53);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (24, 'Henry', 'Harris', 'Rachel', '05xrN8a2t', 'rharrisj@kickstarter.com', true, 28);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (25, 'Juan', 'Harris', 'Rose', 'Sbi34f8am', 'rharrisk@reference.com', false, 38);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (26, 'Karen', 'Butler', 'Kathy', '8xRCi0rghiAm', 'kbutlerl@mtv.com', false, 67);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (27, 'Robert', 'Jordan', 'Patricia', 'fgh8wZ', 'pjordanm@cam.ac.uk', true, 100);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (28, 'Donald', 'Wright', 'Harry', 'xOhaL2iG7ttr', 'hwrightn@networksolutions.com', true, 62);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (29, 'Marilyn', 'Gray', 'Sara', '1zGyHfiSf', 'sgrayo@simplemachines.org', false, 11);
insert into USER (user_id, firstname, lastname, login, password, email, enabled, points) values (30, 'Gregory', 'Porter', 'Henry', 'J3Nttmbndhvh', 'hportero@zdnet.com', false, 81);
...
-- CHALLENGES!
insert into CHALLENGE (challenge_id, name, description, status, category, points, reward_type, reward_quantity, creator_id) values (1, 'Beer Chaenge', 'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat. In congue. Etiam .', 'DONE', 'SPORT', 96, 'POINTS', 'SMALL', 1);
insert into CHALLENGE (challenge_id, name, description, status, category, points, reward_type, reward_quantity, creator_id) values (2, 'Ice bucket challenge', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum. Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, ', 'IN_PROGRESS','SPORT', 22, 'POINTS', 'SMALL', 2);
