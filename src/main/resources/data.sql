...
insert into USER (user_id, firstname, lastname, login, password, email, generalpointsquantity, enabled) values (6, 'Rafal', 'Chavez', 'Rebecca', 'xBkxbL8', 'rchavez1@cnbc.com', 42, true);
...
insert into USER (user_id, firstname, lastname, login, password, email, generalpointsquantity, enabled) values (8, 'Rafal', 'Armstrong', 'Martin', '1093ZyY', 'marmstrong3@disqus.com', 5, false);
insert into USER (user_id, firstname, lastname, login, password, email, generalpointsquantity, enabled) values (9, 'Rafal', 'Jenkins', 'Laura', 'hYRpSEz5y2', 'ljenkins4@cnbc.com', 123, true);
...
-- -- CHALLENGES!
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (1, 'Sport challenge', 'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat. In congue. Etiam .', 'DONE', 'SPORT',  'POINTS', 'SMALL', 1, 2,'2011-11-09',6, 'DAYS', '1,2,3,4,5', 50);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (2, 'Ice bucket challenge', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum. Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, ', 'IN_PROGRESS','SPORT',  'POINTS', 'SMALL', 2, 3,'2011-11-09', 3, 'WEEKS', '1,2,3,4,5', 17);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (5, 'Runmagedon Weteran challenge', 'Morbi non quam nec dui luctus rutrum. Nulla tellus. In sagittis dui vel nisvehicula condimentum. Curabitur in libero ut massa volutpat convallisvehicula condimentum. Curabitur mass.', 'IN_PROGRESS', 'SPORT', 'POINTS', 'MEDIUM', 5, 2,'2011-11-09', 3, 'MONTHS', '1,2,3,4,5', 12);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (6, 'Two girls one jar challenge', 'Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat. In congue. Etiam culis justo. In hac habitasse', 'IN_PROGRESS', 'SPORT', 'POINTS', 'MEDIUM', 6, 2,'2011-11-09', 3, 'WEEKS', '1,2,3,4,5', 42);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (4, 'Runmagedon Ice challenge', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet. Maecenas leo odio, condimentum id, luctus nec, molesvehicula condimentum. Curabitur in libero ut ma', 'DONE', 'SPORT', 'POINTS', 'MEDIUM', 4, 2,'2011-11-09', 3, 'WEEKS', '1,2,3,4,5', 43);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (7, 'Sing something challenge', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus. In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purust non, pretium quis, lectus. Suspendisse potenti.', 'IN_PROGRESS', 'SPORT',  'POINTS', 'MEDIUM', 7, 2, '2011-11-09',3, 'WEEKS', '1,2,3,4,5', 12);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (8, 'Rafal to gsdfgdsf challenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 2, '2011-11-09',3, 'WEEKS', '1,2,3,4,5', 87);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (9, 'Eat bananas ', 'Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus. Phasellus in felis. Donec semper savehiculaimentum. Curabitur in libero ut massa volutpat convallispien aui.', 'IN_PROGRESS', 'SPORT',  'POINTS', 'BIG', 9, 4,'2011-11-09', 3, 'WEEKS', '1,2,3,4,5', 98);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, end_date, period_quantity, period_unit, voters, points_quantity) values (10, 'Karol to gsdfgdsf, potwierdzone info', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ','IN_PROGRESS' ,'SPORT',  'POINTS', 'BIG', 10, 4,'2011-11-09', 3, 'WEEKS', '1,2,3,4,5', 34);

insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (11, 'Rafal to gsdfgdsf challenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 4, '', 54);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (12, 'Rafal to kgfd', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 4, '', 23);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (13, 'Rafal to andrzej', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 4, '', 76);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (14, 'Rafal to ggrazyna', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 4, '', 31) ;
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (15, 'Rafal to fasdfsgsdfgdsf challenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 4, '', 87);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (16, 'Rafal to gfdgdfgsdfgdsf challenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 4, '', 12);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (17, 'Rafal to hfghfggsdfgdsf challenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 5, '', 53);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (18, 'Rafal to gsdfgdsf chhfghfgallenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 5, '', 12);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (19 , 'Rafal to gsdfgdsf chhfghallenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 5, '', 11);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (20, 'Rafal to gdhfej hfgchallenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 5, '', 65);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (21 , 'Rafal to gsdfgdsf hdfgchallenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 5, '', 12);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (22, 'Rafal to gdhgfej chahfllenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 5, '', 42);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, voters, points_quantity) values (23, 'Rafal to gsdfgdsf chalhdfhlenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 5, '', 12);
...
-- Example challenges categories
insert into CHALLENGE_CATEGORY (CHALLENGE_CATEGORY_ID, CHALLENGE_CATEGORY_NAME) values (1,'sport');
insert into CHALLENGE_CATEGORY (CHALLENGE_CATEGORY_ID, CHALLENGE_CATEGORY_NAME) values (2,'automotive');
...
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID) values (1,'FRIEND_INVITE','ACTIVE','message message message',2,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID) values (2,'FRIEND_INVITE','ACTIVE','message message message',3,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID) values (3,'FRIEND_INVITE','ACTIVE','message message message',4,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID) values (4,'FRIEND_INVITE','ACTIVE','message message message',5,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID) values (5,'ACCEPT_INVITATION','ACTIVE','message message message',2,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID,CHALLENGE_ID) values (6,'CHALLENGE_INVITATION','ACTIVE','message message message',2,1,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID) values (7,'REJECT_INVITATION','ACTIVE','message message message',6,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID,CHALLENGE_ID) values (8,'CHALLENGE_ACCEPTANCE','ACTIVE','message message message',2,1,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID,CHALLENGE_ID) values (9,'CHALLENGE_REFUSE','ACTIVE','message message message',2,1,1);
insert into NOTIFICATION(NOTIFICATION_ID, TYPE,STATUS,MESSAGE,CREATOR_ID,SUBJECT_ID,CHALLENGE_ID) values (10,'CHALLENGE_SUCCESS','ACTIVE','message message message',2,1,1);