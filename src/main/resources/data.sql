...
-- CHALLENGES!
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (1, 'Beer Chaenge', 'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat. In congue. Etiam .', 'DONE', 'SPORT',  'POINTS', 'SMALL', 1, 2, 'DAYS', 6);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (2, 'Ice bucket challenge', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum. Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, ', 'IN_PROGRESS','SPORT',  'POINTS', 'SMALL', 2,3, 'WEEKS', 3);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (5, 'Runmagedon Weteran challenge', 'Morbi non quam nec dui luctus rutrum. Nulla tellus. In sagittis dui vel nisvehicula condimentum. Curabitur in libero ut massa volutpat convallisvehicula condimentum. Curabitur mass.', 'IN_PROGRESS', 'SPORT', 'POINTS', 'MEDIUM', 5, 2, 'MONTHS', 3);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (6, 'Two girls one jar challenge', 'Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat. In congue. Etiam culis justo. In hac habitasse', 'IN_PROGRESS', 'SPORT', 'POINTS', 'MEDIUM', 6, 2, 'WEEKS', 3);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (4, 'Runmagedon Ice challenge', 'In quis justo. Maecenas rhoncus aliquam lacus. Morbi quis tortor id nulla ultrices aliquet. Maecenas leo odio, condimentum id, luctus nec, molesvehicula condimentum. Curabitur in libero ut ma', 'DONE', 'SPORT', 'POINTS', 'MEDIUM', 4, 2, 'WEEKS', 3);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (7, 'Sing something challenge', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus. In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purust non, pretium quis, lectus. Suspendisse potenti.', 'IN_PROGRESS', 'SPORT',  'POINTS', 'MEDIUM', 7, 2, 'WEEKS', 3);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (8, 'Rafal to gsdfgdsf challenge', 'Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mm vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida ', 'DONE', 'SPORT',  'POINTS', 'BIG', 8, 2, 'WEEKS', 3);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (9, 'Eat bananas ', 'Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus. Phasellus in felis. Donec semper savehiculaimentum. Curabitur in libero ut massa volutpat convallispien aui.', 'IN_PROGRESS', 'SPORT',  'POINTS', 'BIG', 9, 4, 'WEEKS', 3);
insert into CHALLENGE (challenge_id, name, description, status, category, reward_type, reward_quantity, creator_id, subject_id, period, period_unit) values (10, 'Karol to gsdfgdsf, potwierdzone info', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ','IN_PROGRESS' ,'SPORT',  'POINTS', 'BIG', 10, 4, 'WEEKS', 3);
